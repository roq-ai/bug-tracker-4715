...
import { getBugs, deleteBugById } from 'apiSdk/bugs';
...
export function BugListPage(props: BugListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<BugInterface>>(
    () => `/bugs?params=${JSON.stringify(params)}`,
    fetcher,
  );
